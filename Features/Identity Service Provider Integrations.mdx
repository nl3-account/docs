---
title: 'Identity Service Provider Integrations'
description: 'Auth0, Microsoft Azure, AWS Cognito, and AWS IAM'
---
...
### Supported Native Language Integrations
For more information about integrating Cloud Identity JIT Access into other applications, refer to the following page:

<Card title="Native Language Integrations" icon="code" href="/Features/Native Language Integrations">
Node JS, Python, and Microsoft .NET Framework
</Card>
...
<Card title="Users, Groups, and Enpoints" icon="user" href="/Features/Users, Groups, and Endpoints">
