...
<CardGroup>
    <Card title="Desktop Browser" href="/Desktop User Guide" icon="https://fontawesome.com/icons/desktop?f=classic&s=solid">
    Signing into the Company Portal using a web browser.
    </Card>
    <Card title="Mobile Device Application" href="/Mobile User Guide" icon="https://fontawesome.com/icons/mobile-screen-button?f=classic&s=solid">
...
<AccordionGroup>
    <Accordion title="Windows" icon="/icons/windows">
## Windows
...
### Removal
    ...
    <Accordion title="Linux" icon="/icons/linux">
## Linux
...
```
    ...
    <Accordion title="MacOS" icon="/icons/apple">
    ## Apple... Coming soon!
