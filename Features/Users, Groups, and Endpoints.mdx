...
<CardGroup>
    <Card title="Desktop Browser" href="/Desktop User Guide" icon="desktop">
    Signing into the Company Portal using a web browser.
    </Card>
    <Card title="Mobile Device Application" href="/Mobile User Guide" icon="mobile-screen-button">
...
<Card title="Activity Logs and Cyber Policies" href="/Features/Cyber Policies and Activity Logs" icon="user-lock">
