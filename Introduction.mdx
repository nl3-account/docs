...
<CardGroup cols={2}>
  <Card
    title="Setting  up  your  Account  for  Desktop"
    icon="user"
    href="/Features/Setting up your Account for Desktop"
  >
    Registering your company to the NextLevel3 Company Portal using your desktop
  </Card>
   <Card
    title="Setting  up  your  Account  for  Mobile"
    icon="user"
    href="/Features/Setting up your Account for Mobile"
  >
    Registering your company to the NextLevel3 Company Portal using your mobile device
  </Card>
  <Card
  ...
  <Card 
    title="JIT  Policies  and  Monitoring  Activity" 
    href="/Features/JIT Policies and Activity Logs" 
    icon="user-lock"
    >
    Monitoring account activity and creating JIT policies in the portal
  </Card>
  <Card 
    title="JIT  Approvals" 
    href="/Features/JIT Approvals" 
    icon="user-lock"
    >
    Creating and Managing your JIT Approvals
  </Card>
  <Card 
    title="JIT Privileged Access Management" 
    href="/Features/JIT Privileged Access Management" 
    icon="user-lock"
    >
    Creating and Managing your JIT Privileged Access
  </Card>
  <Card
...
Next Level3's JIT Privileged Access Management provides time-based and approval-based role activation to mitigate the risks of excessive, unnecessary, or misused access permissions on resources. 
