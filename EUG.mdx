...
##Activity Logging and Cyber Policy

Once you have set up your integrations, the next step is utilizing the Activity Log and Cyber Policy features.

Next Level3 Cloud Identity JIT Access allows you to set up cyber policies for your applications and monitor LOCKED/UNLOCKED application and account statuses, allowed/blocked login attempts, and cyber policy activity logs.
