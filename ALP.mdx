...
###Policy Types
Currently, there are three policy types supported by the Next Level3 platform including;
...
<Tabs>
    <Tab icon={clock-regular.svg} title="Scheduled">
###Scheduled Policies
...
[policy](/images/policy4.png)
    ...
    <Tab icon={circle-exclamation-solid.svg} title="Alert">
...
<Tab icon={unlock-keyhole-solid.svg} title="Multi-Approval">
